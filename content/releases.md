...
This page describes the release process as well as the currently planned release schedule for upcoming releases as well as the respective release schepherds. Release shepherds are chosen on a voluntary basis.
...
* With the pre-release the release shepherd is responsible for running and monitoring a benchmark run of the pre-release for 3 days, after which, if successful, the pre-release is promoted.
